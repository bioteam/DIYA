# $Id: rpsblastCDS.pm 261 2008-12-03 15:31:54Z briano $
#--------------------------------------------------------------------------
# ©Copyright 2008
#
...
sub parse {
	...
	my $blastout = $diya->_outputfile("rpsblastCDS");
	print "Parsing \'" . $blastout . "\'\n" if $diya->verbose;

	my $blastparser = Bio::SearchIO->new(-file => $blastout,
													 -format => 'blast' );
